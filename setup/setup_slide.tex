...
\newcommand{\firstpage}{
	\begin{frame}[plain,noframenumbering]
		\titlepage
			\note[item]{Hello evey one
				\begin{itemize}
					\item thank you for supervisor to introducing me
					\item I would also like to thank the audiance for their presence in this room.
				\end{itemize}
			}
		
			\note[item]{so, My name is DJOUDI Aghiles
				\begin{itemize}
					\item I am a Phd student at Paris-est university
					\item I worked as a research ingeneer at Sorbonne univesity
					\item and I am hear to present my work named ""
				\end{itemize}
			}
