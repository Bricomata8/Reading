{
	...
	"configOptions": {
		"getCollections": true,
		"hash": "35699c24f51e5233566be67dcdd3a99e-dd611ac50edb9a6e3718ee4f020784ae"
	},
	"displayOptions": {
		"exportNotes": false,
...
class Reference {
    ...
    add(field) {
        ...
        if (Translator.preferences.skipField[field.name])
            return;
        if (field.enc === 'date') {
            if (!field.value)
                return;
