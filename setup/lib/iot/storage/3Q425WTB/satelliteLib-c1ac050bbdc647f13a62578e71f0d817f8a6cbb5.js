...
s.list1=_satellite.getVar('customerIDs');
  ...
  "pageLoadRules": [
    {"name":"1. Data Element Mapping","trigger":[{"engine":"sc","command":"setVars","arguments":[{"prop1":"%website%","prop11":"%pubType%","prop12":"%pubTitle%","prop2":"%pageGroup%","prop3":"%pageTemplate%","prop4":"%pageSubtype%","prop5":"%pageTitle%"}]},{"command":"loadBlockingScript","arguments":[{"sequential":true,"scripts":[{"src":"satellite-5aaec36164746d79c1001d14.js"}]}]}],"event":"pagetop"},
    {"name":"1. Global site tag","trigger":[{"command":"loadScript","arguments":[{"sequential":false,"scripts":[{"src":"satellite-5cf7bd7564746d596c000241.js"}]}]}],"event":"pagebottom"},
...
return hostname;
  ...
  "appVersion": "7QN",
  "buildDate": "2019-06-11 15:06:35 UTC",
  "publishDate": "2019-06-11 15:06:33 UTC"
});
})(window, document);
