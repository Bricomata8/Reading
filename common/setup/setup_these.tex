...
%	\doublespacing
	...
	\addcontentsline{toc}{chapter}{Abstract}
		\input{src/0/1_1_abstract_english}

	\chapter*{Résumé}{}
		\input{src/0/1_2_abstract_french}

	\includepdf[pages=1]{src/0/1_3_abstract_tifinagh.pdf}

	\includepdf[pages=1]{src/0/1_4_abstract_arabic.pdf}

	\chapter*{Acknowledgements}{}
	\addcontentsline{toc}{chapter}{Acknowledgements}
		\input{src/0/2_acknowledgements}

	\chapter*{Dedication}{}
	\addcontentsline{toc}{chapter}{Dedication}
	\input{src/0/3_dedication}
}
