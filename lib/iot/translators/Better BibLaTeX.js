{
	...
	"priority": 50,
	"inRepository": false,
	"lastUpdated": "2018-05-31 14:51:14"
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const debug_formatter_ts_1 = __webpack_require__(/*! ../../content/debug-formatter.ts */ 11);
function debug(...msg) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const jabref_ts_1 = __webpack_require__(/*! ../bibtex/jabref.ts */ 12); // not so nice... BibTeX-specific code
const debug_ts_1 = __webpack_require__(/*! ../lib/debug.ts */ 0);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../webpack/buildin/module.js */ 6)(module), __webpack_require__(/*! ./../webpack/buildin/global.js */ 5)))
...
Object.defineProperty(exports, "__esModule", { value: true });
const debug_ts_1 = __webpack_require__(/*! ./debug.ts */ 0);
...
Object.defineProperty(exports, "__esModule", { value: true });
const debug_ts_1 = __webpack_require__(/*! ../lib/debug.ts */ 0);
const markupparser_ts_1 = __webpack_require__(/*! ../lib/markupparser.ts */ 8);
const HE = __webpack_require__(/*! he */ 7);
const unicodeMapping = __webpack_require__(/*! ./unicode_translator.json */ 4);
...
Object.defineProperty(exports, "__esModule", { value: true });
const stringify = __webpack_require__(/*! json-stringify-safe */ 10);
...
Object.defineProperty(exports, "__esModule", { value: true });
const exporter_ts_1 = __webpack_require__(/*! ../lib/exporter.ts */ 1);
const unicode_translator_ts_1 = __webpack_require__(/*! ./unicode_translator.ts */ 9);
const debug_ts_1 = __webpack_require__(/*! ../lib/debug.ts */ 0);
const datefield_ts_1 = __webpack_require__(/*! ./datefield.ts */ 3);
...
Object.defineProperty(exports, "__esModule", { value: true });
const reference_ts_1 = __webpack_require__(/*! ./bibtex/reference.ts */ 13);
const exporter_ts_1 = __webpack_require__(/*! ./lib/exporter.ts */ 1);
const debug_ts_1 = __webpack_require__(/*! ./lib/debug.ts */ 0);
...
reference_ts_1.Reference.prototype.lint = __webpack_require__(/*! ./bibtex/biblatex.qr.bcf */ 2);
    ...
    while (item = exporter_ts_1.Exporter.nextItem()) {
        ...
        */
        ...
        if (item.cslVolumeTitle) { // #381
            debug_ts_1.debug('cslVolumeTitle: true, type:', item.referenceType, 'has:', Object.keys(ref.has));
            if (item.referenceType === 'book' && ref.has.title) {
                debug_ts_1.debug('cslVolumeTitle: for book, type:', item.referenceType, 'has:', Object.keys(ref.has));
            ...
            if (['bookSection', 'chapter'].includes(item.referenceType) && ref.has.booktitle) {
                debug_ts_1.debug('cslVolumeTitle: for bookSection, type:', item.referenceType, 'has:', Object.keys(ref.has));
                ref.add({ name: 'maintitle', value: item.cslVolumeTitle }); // ; to prevent chaining
...
; Zotero.debug('BBT: loaded translators/Better BibLaTeX.ts'); } catch ($wrap_loader_catcher_translators_Better_BibLaTeX_ts) { Zotero.debug('Error: BBT: load of translators/Better BibLaTeX.ts failed:' + $wrap_loader_catcher_translators_Better_BibLaTeX_ts + '::' + $wrap_loader_catcher_translators_Better_BibLaTeX_ts.stack) };
