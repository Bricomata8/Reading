...
%\scriptsize
	...
	\multirow{4}{*}{Application layer}& Service time                      &                        \\
                                      & Service availability              &                        \\
                                      & Service cost                      &                        \\
                                      & Service reliability               &                        \\\hline

	\multirow{5}{*}{Network layer}    & Bandwidth                         &                        \\
                                      & Packet loss                       &                        \\
                                      & Jitter                            &                        \\
                                      & Delay                             &                        \\
                                      & Availability                      &                        \\\hline

	\multirow{13}{*}{Radio layer}     & \textbf{Energy consumption}       &                        \\
                                      & Sleep management                  &                        \\
...
%\scriptsize
	...
	\multirow{12}{*}{Application layer} & (\textbf{T}) Throughput                 & (\textbf{RT}) Response Time            \\
	...
	\multirow{1}{*}{Network layer}      & 										  &									    	 \\
	\multirow{1}{*}{Radio layer}        & 										  &	Bit error rate									  \\
	\end{tabulary}
