...
\scriptsize
	...
	\textbf{-}  & Sensitivity & Data Rate &  & Sensitivity & Data Rate &  & Sensitivity & Data Rate &  & \\
	\textbf{6}  & -118        &           &  & -115        &           &  & -111        &           &  & \\
	\textbf{7}  & -123        &           &  & -120        &           &  & -116        &           &  & \\
	\textbf{8}  & -126        &           &  & -123        &           &  & -119        &           &  & \\
	\textbf{9}  & -129        &           &  & -125        &           &  & -122        &           &  & \\
	\textbf{10} & -132        &           &  & -128        &           &  & -125        &           &  & \\
	\textbf{11} & -133        &           &  & -130        &           &  & -128        &           &  & \\
	\textbf{12} & -136        &           &  & -133        &           &  & -130        &           &  & \\\hline
	\end{tabulary}
\caption{\label{tab:} Receiver sensitivity [dBm]}
\end{table}
