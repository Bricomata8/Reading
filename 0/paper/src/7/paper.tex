...
%\title{IoT-based Urban Traffic-Light Control:  Modelling, Prototyping and Evaluation of MQTT protocol}
...
%\IEEEauthorblockA{
%  ECE Paris$^{\ddagger}$, LACSC Laboratory, 37 Quai de Grenelle, 75015 Paris, France\\
...
In this paper, we propose a new architecture of Urban Traffic Light Control based on an IoT network (IoT-UTLC).
...
After verification and validation of our solution using a UPPAAL model checker,
	our system has been prototyped. Motes' functions have been implemented on Contiki OS and connected through a 6LoWPAN/IEEE 802.15.4 network.
...
% \begin{IEEEkeywords} IoT, WSN, Smart Cities, Traffic Lights Control, Cloud, Edge and Fog Computing, 6LoWPAN, Contiki OS, QoS, MQTT, UPPAAL
% \end{IEEEkeywords}
