...
Hardware requirements:
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			{868 mhz antenne 3dBi omni fibre de verre gsm antenne lorawan}
			\item \href{https://www.lextronic.fr/antennes/507-antenne-868-mhz-ground-plane-pour-base.html}
			{Antenne 868 MHz "Ground plane" pour base (4 radians)}
			...
			{ALLISHOP 868 Mhz 5dbi Gain OMNI antenne SMA mâle 19 cm rotatif}
%			\item \href{https://fr.aliexpress.com/item/868MHZ915MHZ-GSM-3G-antenna-small-sucker7dbi-aerial-3meters-SMA-male2/32512220307.html?spm=a2g0s.9042311.0.0.27426c37eBDSMw}
%			{1 PC 868 MHZ/915 MHZ/GSM/3G antenne petite ventouse 7dbi antenne}
...
%			\item \href{https://www.sparkfun.com/products/9873}
%			{SparkFun FTDI Basic Breakout - 3.3V}
%			\item \href{https://fr.aliexpress.com/store/product/Free-shipping-FT232RLFT232-FTDI-USB-3-3V-5-5V-to-TTL-Serial-Adapter-ModuleMini/1735233_32648254875.html?spm=2114.12010608.0.0.PizHXM}
%		{Livraison gratuite FT232RL FT232 FTDI USB 3.3 V 5.5 V à TTL}
