...
\begin{itemize}
	\item Connect sensors to the gateway.\cite{thubert_6tisch_2015}
	\item Connect the gateway to the infrastructure. \footnote{jhjh}
	\item Store \& Analyze sensors data. \footfullcite{thubert_6tisch_2015}
\end{itemize}
