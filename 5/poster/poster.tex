...
\headerbox{2. Genetic Algorithm}{name=model,column=0,below=introduction,span=1}{
    A genetic algorithm is a search heuristic that is inspired by \cite{vlahogianni_optimized_2005}.
...
\headerbox{4. Problem statement}{name=image,span=2,column=1,below=introduction}{
    \begin{center}
...
\headerbox{7. Conclusions}{name=conclusion,column=1,below=sea,span=2,above=bottom}{
