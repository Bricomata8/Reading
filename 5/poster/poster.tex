...
\input{/home/aghiles/Aghiles/Redaction/setup/setup_poster}
...
\headerbox{2. Genetic Algorithm}{name=model,column=0,below=mcs,span=1}{
    A genetic algorithm is a heuristic search that is used to understand natural ADN selection  \cite{vlahogianni_optimized_2005}.
