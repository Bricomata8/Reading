...
The exponential grow of IoT application in both industry and academic research raises many questions in wireless sensor network field.
% Cause of the problem 2
Heterogeneous networks of IoT devices strongly depend on the ability on IoT devices to adapt their data transmission parameters to the application requirement running at each time.
% The problem 
